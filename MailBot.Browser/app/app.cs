...
using MailBot.Browser.controllers;

namespace MailBot.Browser.app
{
    internal static class app
    {
        ...
        {
            IJobDetail jobDetail = JobBuilder.Create<BrowserMain>()
