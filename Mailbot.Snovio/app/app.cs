...
using MailBot.Snovio.controllers;
using System;
...
namespace MailBot.Snovio.app
{
    internal static class app
    {
        ...
        {
            IJobDetail jobDetail = JobBuilder.Create<SnovioMain>()
